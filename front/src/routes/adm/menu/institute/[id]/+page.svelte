...
<div class="w-[95%] h-screen flex justify-center">
    <form class="flex flex-col gap-4 w-full h-full" method="POST" on:submit|preventDefault={submitModifySchoolForm} on:keydown={preventFormSubmit}>
        <div class="overflow-x-auto h-full">
            <table class="table">
              <tbody>
                <tr>
                  <td class="border-b p-1 text-[15px] w-[150px] font-bold">기관명<span class="ml-1 text-red-500">*</span></td>
                  <td class="border-b p-3">
                    <input name="schoolName" type="text" placeholder="기관명" class="input input-bordered w-[250px]" value={schoolDto.schoolName}/>
                  </td>
                </tr>
                <tr>
            ...
            <div class="flex flex-row mt-10 mb-10 justify-center gap-2">
                <button class="btn btn-block btn-outline border-gray-400 gap-1 w-[100px]" type="button" on:click={() => rq.goTo('/adm/menu/institute')}>
                    <span>목록</span>
                </button>
