<script lang="ts">
    ...
    async function submitNewSchoolForm(this: HTMLFormElement) {
        ...
        const { data, error } = await rq.apiEndPoints().POST('/api/v1/schools/institute/new', {
            body: {
                region: regionInput,
              ...
              <tbody>
                <tr>
                  ...
                  <td class="border-2 p-1">
                    <input name="schoolName" type="text" placeholder="기관명" class="input input-bordered w-full"/>
                  </td>
                </tr>
                <tr>
